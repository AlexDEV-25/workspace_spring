...
public class MyConfiguration {
	...
	private final SpringHibernateApplication springHibernateApplication;

	MyConfiguration(SpringHibernateApplication springHibernateApplication) {
		this.springHibernateApplication = springHibernateApplication;
	}
