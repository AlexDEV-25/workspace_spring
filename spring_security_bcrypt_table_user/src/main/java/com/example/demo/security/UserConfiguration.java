...
public class UserConfiguration {
	...
	public JdbcUserDetailsManager jdbcUserDetailsManager(DataSource dataSource) {
		...
		jdbcUserDetailsManager.setUsersByUsernameQuery("SELECT * FROM accounts WHERE id=?");
		jdbcUserDetailsManager.setAuthoritiesByUsernameQuery("SELECT * FROM roles WHERE id=?");
