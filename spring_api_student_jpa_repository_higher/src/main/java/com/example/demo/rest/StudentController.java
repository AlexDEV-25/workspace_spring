...
public class StudentController {
	...
	public List<Student> findByFirstName(@PathVariable String firstname) {
		return this.ss.findByFirstName(firstname);
	}

	@GetMapping("/notfirstname/{firstname}")
	public List<Student> findByFirstNameNot(@PathVariable String firstname) {
		return this.ss.findByFirstNameNot(firstname);
	}

	@GetMapping("/notfirstnamequery/{firstname}")
	public List<Student> findByFirstNameNotQuery(@PathVariable String firstname) {
		return this.ss.findByFirstNameNotQuery(firstname);
	}

	@GetMapping("/notlikefirstnamequery/{firstname}")
	public List<Student> findByFirstNameNotLikeQuery(@PathVariable String firstname) {
		return this.ss.findByFirstNameNotLikeQuery(firstname);
	}
